========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта Проект Поверхности 2ого порядка
========================================================================

Это приложение Проект Поверхности 2ого порядка создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения Проект Поверхности 2ого порядка.


Проект Поверхности 2ого порядка.vcxproj
...
Проект Поверхности 2ого порядка.vcxproj.filters
...
Проект Поверхности 2ого порядка.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем Проект Поверхности 2ого порядка.pch и файла предкомпилированных типов с именем StdAfx.obj.
